...
static const char *const yytname[] =
{
  ...
  "type", "funid", "letid", "intid", "boolid", "vars", "exprs", "expr", YY_NULLPTR
};
#endif
...
#line 25 "lab_yacc.y"
                                                          {
  insert_child((yyvsp[-6].val));
  for (int i = 0; i < (yyvsp[-5].val); i++) insert_child(pop_int(&tmp_r, &tmp_t));
...
#line 1504 "y.tab.c"
  ...
  case 10:
#line 40 "lab_yacc.y"
           { (yyval.val) = insert_node((yyvsp[0].str), INTID);}
#line 1510 "y.tab.c"
    break;

  case 11:
#line 41 "lab_yacc.y"
            { (yyval.val) = insert_node((yyvsp[0].str), BOOLID);}
#line 1516 "y.tab.c"
    break;

  case 12:
#line 43 "lab_yacc.y"
                                {push_int ((yyvsp[-3].val), &tmp_r, &tmp_t); (yyval.val) = (yyvsp[0].val) + 1;}
#line 1522 "y.tab.c"
    break;
