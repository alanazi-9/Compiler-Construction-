      ...
      if (asgn->bb != br->id){
        if (br->cond == 0){
          ...
          if (br->succ1 != -1)
          {
            ...
            else
            {
              ...
              {
                if(br_grand_parent->succ1 == br_parent->id && br_parent->succ1 == br->id && br->cond != 0)
                  printf("(assert (=> (and v%d v%d v%d) (and\n", br_grand_parent->cond, br_parent->cond,br->cond);
                
                if(br_grand_parent->succ2 == br_parent->id && br_parent->succ1 == br->id && br->cond != 0)
                  printf("(assert (=> (and (not v%d) v%d v%d) (and\n", br_grand_parent->cond, br_parent->cond,br->cond);

                if(br_grand_parent->succ1 == br_parent->id && br_parent->succ2 == br->id)
                  printf("(assert (=> (and v%d (not v%d) v%d) (and\n", br_grand_parent->cond, br_parent->cond,br->cond);

                if(br_grand_parent->succ2 == br_parent->id && br_parent->succ2 == br->id)
                  printf("(assert (=> (and (not v%d) (not v%d) v%d) (and\n", br_grand_parent->cond, br_parent->cond,br->cond);
        ...
        else
        {
            ...
            else
            {
              ...
              {
                if(br_grand_parent->succ1 == br_parent->id && br_parent->succ1 == br->id)
                  printf("(assert (=> (and v%d v%d v%d) (and\n", br_grand_parent->cond, br_parent->cond,br->cond);
                
                if(br_grand_parent->succ2 == br_parent->id && br_parent->succ1 == br->id)
                  printf("(assert (=> (and (not v%d) v%d v%d) (and\n", br_grand_parent->cond, br_parent->cond,br->cond);
